...
class PersonForm(forms.ModelForm):
    ...
    def __init__(self, *args, **kwargs):
        ...
        # self.fields['history'].widget.attrs = {
        #     'class': 'form-control',
...
#     dateday = forms.DateField(widget=widgets.AdminDateWidget)
#     datetime = forms.DateField(widget=widgets.AdminTimeWidget)
#     class Meta:
#         model=Schedule
#         fields=['dateday','datetime']
...
class ScheduleForm(forms.ModelForm):
    class Meta:
        ...
        fields = '__all__'
        # fields = ['eventid', 'personid', 'day', 'menuid', forms.DateField(label='Birth Date',widget=DateInput())]

        # dateday = forms.DateField(
        ...
        #     'dateday': forms.DateField(widget=forms.DateInput(format='%Y-%m-%d')),
        # }
